...
public class BlogController {
    ...
    @PostMapping("/blog")
    public ResponseEntity<CustomResponse>saveBlog(@RequestBody @Validated BlogRequest blog, BindingResult bindingResult){
    ...
    @PutMapping("/blog/{id}")
    public ResponseEntity<CustomResponse> updateBlog(@PathVariable int id, @RequestBody @Validated BlogRequest blog, BindingResult bindingResult){
    ...
    public ResponseEntity<CustomResponse> uploadCover(@PathVariable int id, @RequestParam("uploadBlog") MultipartFile file){
        try{
